...
int fts_create_sysfs(struct i2c_client *client)
{
	...
	//printk("FTP: I2CDMABuf_pa=%x,val=%x val2=%x\n",&I2CDMABuf_pa,I2CDMABuf_pa,I2CDMABuf_pa);
...
static const struct file_operations ft_flag_proc_fops = { 
...
int ft5x0x_create_apk_debug_channel(struct i2c_client * pclient)
{
	    //linux-3.10 procfs API changed
#if 1
	ft5x0x_proc_entry=proc_create(PROC_NAME,0777,NULL,&ft_flag_proc_fops);
	 client=pclient;
#else
	...
	if (NULL == ft5x0x_proc_entry) {
		...
		ft5x0x_proc_entry->data =(void *) client;

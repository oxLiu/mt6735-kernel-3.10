...
#define TPD_KEY_COUNT           11    //  4
#define TPD_KEYS        {KEY_MENU, KEY_HOMEPAGE, KEY_BACK, KEY_LEFT, KEY_RIGHT, KEY_UP, KEY_DOWN, KEY_O, KEY_W, KEY_M, KEY_Z}
#define TPD_KEYS_DIM    {{100,1000,50,30},{250,1000,50,30},{400,1000,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30},{1300,1850,50,30}}

/*********************Custom Define end*************************************************/

//#define TPD_NAME    "FocalTek"
#define TPD_NAME    "FocalTek-ft6336" //cty20140904

...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2755_SENSOR_ID, //GC2755MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	//write_cmos_sensor(0x17, 0x15);//////video inv
	write_cmos_sensor(0x17, 0x14);//////video inv
	...
	/////////////////////   crop   /////////////////////
	////////////////////////////////////////////////////
	write_cmos_sensor(0x92, 0x05);//04//05//04//05
	write_cmos_sensor(0x94, 0x09);//08//09//09//08

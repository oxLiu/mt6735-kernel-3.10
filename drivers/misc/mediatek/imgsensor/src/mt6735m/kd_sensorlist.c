...
static struct i2c_board_info i2c_devs1 __initdata = {I2C_BOARD_INFO(CAMERA_HW_DRVNAME1, 0x78>>1)};
...
int kdSetDriver(unsigned int *pDrvIndex)
{
    ...
    printk("kdsetdriver--g_invokeSocketIdx-----%d\n",g_invokeSocketIdx[i]);
    printk("kdsetdriver--  drvIdx[i] -----%d\n",  drvIdx[i] );
    /*  */
	...
	printk("kdsetdriver-- SensorFunc----%d\n",  g_pInvokeSensorFunc[i]->ScenarioId);

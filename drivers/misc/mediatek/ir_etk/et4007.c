...
#define ET4007_SDA_GPIO			(GPIO53|0x80000000)//(GPIO65|0x80000000)
#define ET4007_BUSY_GPIO		(GPIO67|0x80000000)//(GPIO5|0x80000000)
#define ET4007_POWER_GPIO		(GPIO68|0x80000000)//(GPIO57|0x80000000)
#endif
...
void set_pull(void )
{
	mt_set_gpio_pull_select(ET4007_SDA_GPIO, GPIO_PULL_UP);
	mt_set_gpio_pull_enable(ET4007_SDA_GPIO, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(ET4007_SCL_GPIO, GPIO_PULL_UP);
	mt_set_gpio_pull_enable(ET4007_SCL_GPIO, GPIO_PULL_ENABLE);
}

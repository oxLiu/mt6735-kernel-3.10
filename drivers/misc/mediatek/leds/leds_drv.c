...
#if 0	
	printk("xunhu---0x01==%x--------\n",AW2013_i2c_read_reg(0x01));
	printk("xunhu---0x31==%x--------\n",AW2013_i2c_read_reg(0x31));
	printk("xunhu---0x32==%x--------\n",AW2013_i2c_read_reg(0x32));
	printk("xunhu---0x33==%x--------\n",AW2013_i2c_read_reg(0x33));
	printk("xunhu---0x34==%x--------\n",AW2013_i2c_read_reg(0x34));
	printk("xunhu---0x35==%x--------\n",AW2013_i2c_read_reg(0x35));
	printk("xunhu---0x36==%x--------\n",AW2013_i2c_read_reg(0x36));
	printk("xunhu---0x37==%x--------\n",AW2013_i2c_read_reg(0x37));
	printk("xunhu---0x38==%x--------\n",AW2013_i2c_read_reg(0x38));
	printk("xunhu---0x39==%x--------\n",AW2013_i2c_read_reg(0x39));
	printk("xunhu---0x3a==%x--------\n",AW2013_i2c_read_reg(0x3a));
	printk("xunhu---0x3b==%x--------\n",AW2013_i2c_read_reg(0x3b));
	printk("xunhu---0x3c==%x--------\n",AW2013_i2c_read_reg(0x3c));
	printk("xunhu---0x3e==%x--------\n",AW2013_i2c_read_reg(0x3e));
	printk("xunhu---0x3f==%x--------\n",AW2013_i2c_read_reg(0x3f));
#endif
}
...
static const struct i2c_device_id aw2013_i2c_id[] = {{"aw2013",0},{}};   
struct i2c_driver aw2013_i2c_driver = {                       
...
static int aw2013_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	printk("[aw2013] aw2013_i2c_probe\n");

    /* Kirby: add new-style driver { */
    aw2013_i2c_client = client;
    
 //   aw2013_i2c_client->addr = aw2013_i2c_client->addr >> 1;

	printk("[aw2013] Attached!! \n");
...
static int __init mt65xx_leds_probe(struct platform_device *pdev)
{
 ...
 err:
	...
	LEDS_DRV_DEBUG("[LED]mt65xx_leds_probe fail!\n");
	return ret;
}
...
static int aw2013_suspend(struct platform_device *pdev, pm_message_t mesg)
{
    return 0;
}

static int aw2013_resume(struct platform_device *pdev)
{
    return 0;
}
// platform structure
static struct platform_driver g_staw2013_Driver = {
    .probe		= aw2013_probe,
    .remove	= aw2013_remove,
    .suspend	= aw2013_suspend,
    .resume	= aw2013_resume,
    .driver		= {
        .name	= "aw2013_flashlight",
        .owner	= THIS_MODULE,
    }
};
static struct platform_device g_staw2013_Device = {
	.name = "aw2013_flashlight",
	.id = -1
};
...
#ifdef XUNHU_T818_BLINK	
////modify by linhui 20150424
	 i2c_register_board_info(FLASHLIGHT_I2C_BUSNUM, &aw2013_i2c_hw, 1);
    
    if(platform_driver_register(&g_staw2013_Driver)){
        printk("failed to register aw2013 driver\n");
        return -ENODEV;
    }

	ret = platform_device_register(&g_staw2013_Device);
	if (ret)
		printk("[LED]g_staw2013_Device:dev:E%d\n", ret);
...
#ifdef XUNHU_T818_BLINK	
	///for test by linhui 
	platform_driver_unregister(&g_staw2013_Driver);
	platform_device_unregister(&g_staw2013_Device);
#endif	
/* platform_device_unregister(&mt65xx_leds_device); */
}

...
#elif defined(USING_EXTAMP_HP)
	mt_set_gpio_mode(GPIO59, GPIO_MODE_00);  
	 mt_set_gpio_dir(GPIO59, GPIO_DIR_OUT) ;   
	 mt_set_gpio_mode(GPIO121, GPIO_MODE_00);  
	  mt_set_gpio_dir(GPIO121, GPIO_DIR_OUT) ; 

	  mt_set_gpio_out((GPIO59 | 0x80000000), 0);
...
mt_set_gpio_out((GPIO59 | 0x80000000), 1);
